...
contextBridge.exposeInMainWorld('ghostlayer', {
  ...
  license: {
    ...
    isRegexCategoryAllowed: (category: string): Promise<boolean> => ipcRenderer.invoke('license:isRegexCategoryAllowed', category),
    startTrial: (): Promise<LicenseInfo> => ipcRenderer.invoke('license:startTrial'),
  },
