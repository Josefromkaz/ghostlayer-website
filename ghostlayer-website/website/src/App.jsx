...
const translations = {
  ru: {
    ...
    hero: {
      ...
      stats: {
        patterns: 'типов конфиденциальных данных',
...
БИК [BIK_1]`,
    ...
    features: {
      ...
      formats: { title: 'Поддержка форматов', desc: 'PDF (до 50 MB), TXT, DOCX, Markdown, JSON (до 10 MB). Все форматы обрабатываются локально за секунды.' },
    ...
    howItWorks: {
      ...
      steps: [
        { title: 'Загрузите документ', desc: 'Откройте PDF, TXT, DOCX, Markdown или JSON файл в GhostLayer' },
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'PDF (до 50 MB), TXT, DOCX, Markdown и JSON (до 10 MB). Все форматы обрабатываются только в оперативной памяти и никогда не сохраняются на диск.'
        },
      ],
    },
    contactModal: {
  ...
  en: {
    ...
    hero: {
      ...
      demoBtn: 'Watch Demo',
      stats: {
        patterns: 'types of confidential data',
        startup: 'app startup',
...
Routing: [ROUTING_1]`,
    ...
    features: {
      ...
      formats: { title: 'Format Support', desc: 'PDF (up to 50 MB), TXT, DOCX, Markdown, JSON (up to 10 MB). All formats processed locally in seconds.' },
    ...
    howItWorks: {
      ...
      steps: [
        { title: 'Upload Document', desc: 'Open a PDF, TXT, DOCX, Markdown, or JSON file in GhostLayer' },
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'PDF (up to 50 MB), TXT, DOCX, Markdown, and JSON (up to 10 MB). All formats are processed in RAM only and never saved to disk.'
        },
      ],
    },
    contactModal: {
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex items-center gap-8 mt-10 pt-10 border-t border-zinc-800">
                <div>
                  <div className="text-3xl font-bold text-white"><AnimatedNumber value={38} /></div>
