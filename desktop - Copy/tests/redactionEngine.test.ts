...
describe('RedactionEngine', () => {
  describe('runRedaction - Basic Functionality', () => {
    it('should detect email addresses', () => {
      ...
      const matches = runRedaction(text, [], [], []);
    ...
    it('should detect Kazakhstan phone numbers', () => {
  ...
  describe('runRedaction - User Rules (Memory)', () => {
    it('should detect text matching user rules', () => {
  ...
  describe('runRedaction - Custom Patterns', () => {
    it('should detect text matching custom regex patterns', () => {
      ...
      const matches = runRedaction(text, [], customPatterns, []);
    ...
    it('should ignore inactive custom patterns', () => {
      const text = 'Reference: REF-12345-ABC';
      const customPatterns: CustomPattern[] = [
  ...
  describe('runRedaction - False Positive Blacklist', () => {
    it('should skip false positive patterns', () => {
      FALSE_POSITIVE_BLACKLIST.forEach(pattern => {
  ...
  describe('runRedaction - Overlap Resolution', () => {
    it('should resolve overlapping matches (longer match wins)', () => {
  ...
  describe('runRedaction - Replacement Tags', () => {
    it('should generate unique replacement tags', () => {
    ...
    it('should reuse tags for identical text', () => {
  ...
  describe('restoreText - De-anonymization', () => {
    it('should restore original text from tags', () => {
      const original = 'Contact: test@example.com';
      const matches = runRedaction(original, [], [], []);
